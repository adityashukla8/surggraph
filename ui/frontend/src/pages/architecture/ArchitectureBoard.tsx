...
const CONNS: Conn[] = [
  ...
  { n: 7, from: "orchestrator", to: "medgemma", labelLeg: 1, spec: (ch) => ({ from: "bottom", fromOffset: -90, to: "right", via: [{ y: ch.gapY }, { x: ch.modelsX - 15 }] }), label: "MedGemma: Operative record", desc: "MedGemma drafts the operative record — a medical-domain model writes the medical text." },
